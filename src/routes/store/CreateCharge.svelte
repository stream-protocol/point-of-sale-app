...
<div class="card w-96 bg-base-200 shadow border">
    ...
    <div class="card-body px-6 pb-4 text-center ">
        <h1 class="align-center text-xl font-greycliffbold -mt-5 pb-1 text-transparent bg-clip-text bg-gradient-to-br from-[#051150] to-[#00072C]">Enter charge amount</h1>
        <div>
        <svg class="inline-block align-top h-9 w-9 pt-1" xmlns="http://www.w3.org/2000/svg" data-name="86977684-12db-4850-8f30-233a7c267d11" viewBox="0 0 2000 2000">
        ...
        <input bind:value={$pmtAmt} class="w-48 justify-end text-right pr-2 text-xl border border-4 border-accent hover:border-accent from-[#051150] to-[#00072C] pt-1 rounded-lg text-center " placeholder="Enter USDC amount" />
    </div>
    </div>
...
<div class="grid grid-flow-row justify-center pt-5 gap-3">
    <div class="indicator justify-items-center place-self-center">
        <div class="">
            <button on:click={createStore} class="btn normal-case btn-lg bg-gradient-to-br border-accent hover:border-accent from-[#051150] to-[#00072C]">
