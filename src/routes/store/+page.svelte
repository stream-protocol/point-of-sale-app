...
<div class="grid grid-flow-row justify-center gap-4">
    <h1 class="sm:pt-3 pt-1 font-greycliffbold text-4xl text-center text-transparent bg-clip-text bg-gradient-to-br from-[#051150] to-[#00072C]">
        {$storeName}</h1>

    <div class="tabs tabs-boxed justify-items-center place-self-center">
    
        {#if activeTab == 1}
            <a class="tab text-[#FFFFFF] bg-gradient-to-br from-[#051150] to-[#00072C] rounded-lg" on:click={()=>(activeTab=1)}>Create Charge</a> 
        ...
        {:else if activeTab == 2}
            ...
            <a class="tab text-[#FFFFFF] bg-gradient-to-br from-[#051150] to-[#00072C] rounded-lg" on:click={()=>(activeTab=2)}>Transactions</a> 
            <a class="tab " on:click={()=>(activeTab=3)}>Settings</a> 
        {:else if activeTab == 3}
            <a class="tab " on:click={()=>(activeTab=1)}>Create Charge</a> 
            <a class="tab " on:click={()=>(activeTab=2)}>Transactions</a> 
            <a class="tab text-[#FFFFFF] bg-gradient-to-br from-[#051150] to-[#00072C] rounded-lg" on:click={()=>(activeTab=3)}>Settings</a> 
