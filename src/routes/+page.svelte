    ...
    <div class="indicator justify-items-center place-self-center">
        ...
        <div class="card w-96 bg-base-200 shadow border">
            <div class="card-body px-6 pb-4">
                ...
                <p class="text-md -mt-5 font-greycliffmed text-transparent bg-clip-text bg-gradient-to-br from-[#051150] to-[#00072C]">Enter your merchant details</p>
                ...
                <div class="card-actions justify-center">
                    <button on:click={createStore} class="btn normal-case btn-sm bg-gradient-to-br border-accent hover:border-accent from-[#051150] to-[#00072C]">Create Store</button>
                </div>
                <div class="text-md -mb-5 text-center font-greycliffmed text-transparent bg-clip-text bg-gradient-to-br from-[#051150] to-[#00072C]">Powered by
                    <svg class= "inline w-16 h-16 pb-1" viewBox="0 0 86 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <stop offset="0.08" stop-color="#00072C"/>
                        <stop offset="0.3" stop-color="#051150"/>
                        <stop offset="0.5" stop-color="#5497D5"/>
                        <stop offset="0.6" stop-color="#43B4CA"/>
                        <stop offset="0.72" stop-color="#28A6E0"/>
                        <stop offset="0.97" stop-color="#198EFB"/>
                        </linearGradient>
                        </defs>
                        </svg>
                    </div>
...
<div class="flex justify-center flex-row pt-2">
    <footer class="footer footer-center p-2 text-base-content rounded-md">
        ...
        <div class="items-center ">
            ...
            <span class=" text-sm ">© 2023 StreamPay- built by <a class="hover:underline hover:decoration-primary" href="https://www.streamprotocol.org">
