...
<div class="grid grid-flow-row justify-center">
    ...
    <h1 class="sm:pt-3 pt-1 font-greycliffbold text-4xl text-center text-transparent bg-clip-text bg-gradient-to-br from-[#051150] to-[#01BAEF] ">
        {$storeName}</h1>
        <div id="qr-code" >
            <qrCode/>
        </div>
...
<div class="grid grid-flow-row justify-center pt-5 pb-6">
    <div class="indicator justify-items-center place-self-center">
        <div class="">
            <button on:click={cancel} class="btn normal-case btn-lg bg-gradient-to-br border-accent hover:border-accent from-[#051150] to-[#017CEF]"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline w-6 h-6 ">
